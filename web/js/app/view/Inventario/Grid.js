Ext.define('FV.view.Inventario.Grid', {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            menu: [{
                                    ...
                                    iconCls: 'preview',
                                    handler: function() {
                                        var mes = me.down('#combo_monthID').getValue();
                                        if (mes == null)
                                            mes = -1;
                                        Ext.Ajax.request({
                                            scope: this,
                                            ...
                                            url: SITEURL + '/reportes/inventario/' + mes + '/' + me.down('#yearFieldID').getValue(),
                                ...
                                },
                                {
                                    ...
                                    handler: function() {
                                        ...
                                        if (mes === null)
                                            mes = -1;
                                        var uri_string = SITEURL + '/reportes/generar_pdf_inventario/' + mes + '/' + me.down('#yearFieldID').getValue();
                                ...
                                ,
                                {
                                    ...
                                    handler: function() {
                                        ...
                                        if (mes === null)
                                            mes = -1;
                                        var uri_string = SITEURL + '/reportes/generar_xls_inventario/' + mes + '/' + me.down('#yearFieldID').getValue();
                                        window.location.href = uri_string;
